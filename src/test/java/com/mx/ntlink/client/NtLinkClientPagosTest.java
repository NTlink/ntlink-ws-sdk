...
public class NtLinkClientPagosTest {
  ...
  public void timbra_pagos_error20123() throws IOException, SoapClientException {
    ...
    try {
       ...
       *
       * <p>el proxy regresa: cvc-complex-type.2.4.a: Invalid content was found starting with
       * element 'cfdi:Impuestos'. One of '{"http://www.sat.gob.mx/cfd/4":Concepto}' is expected.
       */
    }
  }
