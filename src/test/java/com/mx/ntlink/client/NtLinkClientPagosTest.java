...
public class NtLinkClientPagosTest {
    ...
    public void timbra_pagos_error20223() throws IOException, SoapClientException {
        ...
        try {
            ...
            Assert.assertEquals(
                    "Request Error :CRP20223 - El campo NomBancoOrdExt se debe registrar.",
                    e.getMessage());
        }
    }
    ...
    public void timbra_pagos_error20224() throws IOException, SoapClientException {
        ...
        try {
            ...
            Assert.assertEquals(
                    "Request Error :CRP20224 - El campo CtaOrdenante no se debe registrar.",
                    e.getMessage());
        }
    }
    ...
    public void timbra_pagos_error20229() throws IOException, SoapClientException {
        ...
        try {
            ...
            Assert.assertEquals(
                    "Request Error :CRP20229 - El campo TipoCadPago no se debe registrar. ",
                    e.getMessage());
        }
    }
    ...
    public void timbra_pagos_error20230() throws IOException, SoapClientException {
        ...
        try {
            ...
            Assert.assertEquals(
                    "Request Error :CRP20230 - El campo CertPago se debe registrar.",
                    e.getMessage());
        }
    }
    ...
    public void timbra_pagos_error20231() throws IOException, SoapClientException {
        ...
        try {
            ...
            Assert.assertEquals(
                    "Request Error :CRP20231 - El campo CertPago no se debe registrar.",
                    e.getMessage());
        }
    }
    ...
    public void timbra_pagos_error20232() throws IOException, SoapClientException {
        ...
        try {
            ...
            Assert.assertEquals(
                    "Request Error :CRP20232 - El campo CadPago se debe registrar.",
                    e.getMessage());
        }
    }
    ...
    public void timbra_pagos_error20233() throws IOException, SoapClientException {
        ...
        try {
            ...
            Assert.assertEquals(
                    "Request Error :CRP20233 - El campo CadPago no se debe registrar.",
                    e.getMessage());
        }
    }
    ...
    public void timbra_pagos_error20234() throws IOException, SoapClientException {
        ...
        try {
            ...
            Assert.assertEquals(
                    "Request Error :CRP20234 - El campo SelloPago se debe registrar. ",
                    e.getMessage());
        }
    }
    ...
    public void timbra_pagos_error20235() throws IOException, SoapClientException {
        ...
        try {
            ...
            Assert.assertEquals(
                    "Request Error :CRP20235 - El campo SelloPago no se debe registrar.",
                    e.getMessage());
        }
    }
    ...
    public void timbra_pagos_error20237() throws IOException, SoapClientException {
        ...
        try {
            ...
            Assert.assertEquals(
                    "Request Error :CRP20237 - El campo EquivalenciaDR se debe registrar.",
                    e.getMessage());
        }
    }
    ...
    public void timbra_pagos_error20239() throws IOException, SoapClientException {
        ...
        try {
            ...
            Assert.assertEquals(
                    "Request Error :CRP20239 - El campo ImpSaldoAnt debe mayor a cero.",
                    e.getMessage());
        }
    }
    ...
    public void timbra_pagos_error20241() throws IOException, SoapClientException {
        ...
        try {
            ...
            Assert.assertEquals(
                    "Request Error :CRP20241 - El campo ImpPagado debe mayor a cero.",
                    e.getMessage());
        }
    }
